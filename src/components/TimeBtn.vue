<template>
    <div class="time-btn-wrapper">
        <div class="time-btn" id="timeBtn" @click="viewTime()">
        ...
        <div id="timeValues" class="pos-relative">
            <div class="values-up d-flex">
                ...
                <div class="arrow-controls d-flex flex-column">
                    <IconChevronUp class="control-icon up" />
                    <IconChevronDown class="control-icon down" />
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        hideTime(event) {
            ...
            if (!timeBtnWrapper.contains(event.target)) {
                timeInput.classList.remove("shown");
        ...
        generateTimeValuesOptions() {
            ...
            for (let i = 0; i < this.timeHours; i++) { this.timeValueOptions_upLeft.push(i) }
